// assets.js - База данных V44

const ASSETS_DB = {
    // 1. ИКОНКИ (Для корешка и макета Символ)
    icons: {
        "Love": ["01heart.png"]
        // Добавляйте сюда другие категории иконок
    },

    // 2. ГРАФИКА (Для макета Графика - черное на прозрачном)
    graphics: {
        "Shapes": ["01heart.png"] 
        // Сюда можно добавить абстракции, мазки кисти и т.д.
    }
};
